...
def probe_video(file_path: str) -> Dict:
    ...
    # Check for audio
    has_audio = check_audio_presence(file_path)
    ...
    if has_audio:
        audio_bitrate_kbps = estimate_audio_bitrate(file_path)
...
def check_audio_presence(file_path: str) -> bool:
...
def estimate_audio_bitrate(file_path: str) -> int:
    """
